...
export class QuestClearPathToFarm extends Quest {
  ...
  static setup(scene: SCENE_GAME): void {
    ...
    scene.addObject(new TreeObject(scene, { positionX: 0, positionY: 12, type: 'small', logOnDestroy: false, stumpOnDestroy: false, onDestroy: onDestroy }));
    scene.addObject(new TreeObject(scene, { positionX: 0, positionY: 13, type: 'small', logOnDestroy: false, stumpOnDestroy: false, onDestroy: onDestroy }));
  }
